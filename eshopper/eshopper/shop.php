			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php
						$c = (isset($_GET['c'])) ? $_GET['c'] : $_POST["categorie"];
						
							// On se connecte à MySQL 
							try{
							$bdd = new PDO('mysql:host=localhost;dbname=mg;charset=utf8', 'root', '');
							$req = "SELECT DISTINCT * FROM `produit` WHERE categorie='$c'";
									...
									<div class="product-overlay">
										<div class="overlay-content">
											...
											<form method="get" action="product-details.php" >
													<button style="background-color: transparent;color: black;border: 2px solid transparent;" 
													type="submit" value="<p><?php echo $donnee['id_pro']; ?></p>" name="choix"><i></i><?php echo $donnee['nom']; ?></button>
											</form>
											<!--<p><?php echo $donnee['nom']; ?></p>
											...
											<?php
												...
												?>
												<form method="post" action="shop.php?action=add&pid=<?php echo $donnee["id_pro"]; ?>">
													<input type="hidden" name="quantity" value="1" />
													<input type="hidden" name="categorie" value="<?php echo $c; ?>" />
