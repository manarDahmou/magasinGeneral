			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details">
						...
						if (isset($_GET['choix']) || isset($_GET["pid"])) :
							$choix = (isset($_GET['choix'])) ? $_GET['choix'] : $_GET["pid"];;

							try {
								// On se connecte à MySQL 
								$bdd = new PDO('mysql:host=localhost;dbname=mg;charset=utf8', 'root', '');
								$req = "SELECT * FROM `produit` WHERE id_pro='$choix'";
							...
							<div class="col-sm-7">
								<div class="product-information">
									...
									<span>
										...
										?>
											<form method="post" action="product-details.php?action=add&pid=<?php echo $donnee["id_pro"]; ?>">
												<label>Quantity:</label>
												<input type="text" name="quantity" value="1" size="2" />
												<button class="btn btn-fefault cart" type="submit" value="<?php echo $donnee["id_pro"]; ?>" name="idp"><i class="fa fa-shopping-cart"></i>Add to cart</button>
									...
									<p><b>Availability:</b><?php echo $donnee['quantite']; ?></p>
